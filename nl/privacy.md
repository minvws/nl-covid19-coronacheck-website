...
- De persoon kan via CoronaCheck een digitaal coronatoegangsbewijs genereren. Het coronatoegangsbewijs is maximaal 40 uur geldig (gemeten na het tijdstip waarop de test is afgenomen). Nadat het coronatoegangsbewijs zijn geldigheid heeft verloren, worden het coronatoegangsbewijs en de aangemaakte QR-code automatisch verwijderd bij het openen van de app. De eerste letter van de voor- en achternaam en de geboortedag en –maand als onderdeel van het coronatoegangsbewijs van de persoon worden daarmee ook automatisch verwijderd.
- De persoon kan via coronacheck.nl een coronatoegangsbewijs genereren dat kan worden geprint en gebruikt als fysiek coronatoegangsbewijs. De QR-code (inclusief set identificerende gegevens) wordt verwijderd zodra de persoon de browser waarin de QR-code wordt getoond sluit. Indien de persoon niet zelf de browser sluit verdwijnt de QR-code in de browser automatisch na 40 uur. 
- Het IP-adres dat voor beheers- en beveiligingsdoeleinden wordt verwerkt door Prolocation B.V., wordt na maximaal 7 dagen verwijderd.
- In CoronaCheck Scanner worden geen persoonsgegevens vastgelegd.

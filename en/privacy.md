...
title: Information about the CoronaCheck app with effect from July 1, 2023
---
...
**Warning:**
When showing a QR code, the inspector sees all data the QR code provides in the CoronaCheck app. This is the data that is stored locally on the device and that is linked to the CoronaCheck app. [Click here for an overview of that data](https://coronacheck.nl/en/privacy#overview-of-processed-personal-data).
Please note: if a QR code in the CoronaCheck app is scanned in a country outside the EU or the Schengen zone, different rules for protecting personal data may apply.

...
const dictionary = {
    'nl': {
        ...
        'expiredTestCodeHead': 'Deze code is verlopen',
        ...
        'generalErrorBody': '<p>Dat komt door een technische fout. Neem contact op met de helpdesk van CoronaCheck via 0800-1421.</p>',
        'goBackToStart': 'Naar home',
        'invalidTestCode': 'Geen geldige code',
        ...
        'testCodeDirection': 'Vul de code in die je van je testlocatie hebt gekregen. Of klik op de link in de e-mail die je van je testlocatie hebt ontvangen.',

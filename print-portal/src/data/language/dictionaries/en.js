...
Send an e-mail to helpdesk@coronacheck.nl or call at 0800-1421 (free)`,
        ...
        'instructionsText': `1. Make a print of this test certificate on A4 size paper without adjusting the scale (in black-white is fine)

2. Bring a valid proof of identity to the activity

3. Display your test certificate and proof of identity (and if necessary your entrance ticket) at the entrance
...
Beware: this is not an entrance ticket for the activity you're visiting`,
    ...
    'noTestProofPresentDirection': 'You can only turn a negative test result into a test certificate. Retrieve your test result first.',
    ...
    'preferMobile': 'Prefer having your test certificate on mobile?',
    'preferMobileDirection': 'Then download the app.',
    'printPortalHomeBodyText': '<p>A test certificate on paper is convenient if you don\'t have a smartphone. Here\'s how it works:</p><h3>Access only after testing</h3><p>Get tested when visiting certain venues or activities. Even when you\'ve already been vaccinated. Does your test prove you don\'t have coronavirus (negative test result)? Then you can get access.</p><h3>Your QR code in your pocket</h3><p>If your test proves you don\'t have coronavirus, you can make a personal QR code in this app. This will be your test certificate. The QR code is scanned before you get access.</p><h3>Minimum amount of data</h3><p>Your QR code only states when you tested negative (no coronavirus), the time of testing, and the minimum amount of identifying data: your first name initial, your last name initial, your day of birth, and your month of both. We verify this information to make sure the test result is yours.</p>',
    'printPortalHomeHeader': 'Get access with a test certificate on paper',
    ...
    'yourNegativeTestresultDirection': '<p>This test result is retrieved from the test location.</p><p>Is the below correct? Then you can convert the negative test result into a QR code. This is your test certificate.</p>',
    'yourTestProof': 'Your test certificate',
    'yourTestProofDirection': 'You\'ve made a test certificate,  in the form of a QR code. Read which information the QR code contains. Print the PDF and take it with you.',

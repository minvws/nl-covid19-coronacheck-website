...
const en = {
    ...
    'views': {
        'home': {
            ...
            'pageIntro': '<h2 class="screen-reader-text">Here\'s how it works</h2><p>A certificate on paper is convenient if you don\'t have a smartphone. Here\'s how it works:</p><div class="home__section"><h3>Only access with a certificate</h3><p>Want access to certain locations and activities? Or are you travelling abroad? You can if you have been fully vaccinated or if you have a negative test result that confirms you don’t have corona.</p><p>Please note: not fully vaccinated? Then you can’t make a certificate.</p></div><div class="home__section"><h3>QR code = your proof</h3><p>You can make a QR code of your vaccination or a negative test result. This is your certificate. The QR code is scanned before you get access.</p></div><div class="home__section"><h3>QR codes for the Netherlands and international</h3><p>This app generates a QR code for the Netherlands and one for other countries. Travelling outside of the Netherlands? Then use your international QR code.</p></div>',

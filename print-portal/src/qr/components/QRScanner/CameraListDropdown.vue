<template>
  <div class="camera-list-dropdown">
    <label class="camera-list-dropdown-label" for="select" v-if="label">{{ label }}</label>
    <select id="select" v-model="selected" v-bind="{ disabled }">
